...
const Nav = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    <header
      className={`fixed sm:h-[10vh] md:h-[11vh] h-[8vh] w-full z-20 top-0 start-0 border-b-2   flex justify-between  p-2 flex-wrap flex-nowrap shadow-lg shadow-gray-600 ${
        isDarkMode
